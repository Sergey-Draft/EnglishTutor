        ...
        <div className={s.backimg}>
            ...
            <div className={s.wrapper}>
                <div className={s.container}>
                    <div className={s.intro}> В процессе обучения я использую коммуникативную методику обучения иностранному языку. Эта методика отлично себя зарекомендовала и, на данный момент, уверенно удерживает первую позицию среди всех остальных методик. Хотите научиться разговорить на английском бегло, грамотно, улучшить произношение, не только слышать, но и понимать английскую речь? Тогда эта методика Вам подходит!</div>
                    <div className={s.containerInner}>
                        ...
                        <div className={s.lessonsInner}>
                            <div className={s.lessonsTitle}>Направления преподования</div>
